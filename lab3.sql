...
/* 16 */
SELECT NAME, SURNAME, FATHER_NAME, BERTHDATE FROM T_EMPLOYER 
/* 17 */
SELECT * FROM T_EMPLOYER WHERE SEX = 'M'
/* 18 */
SELECT * FROM T_CATERER 
  WHERE ID_CATERER IN 
...
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (1, 1, 'Имя1', 'Фамилия1', 'Отчество1', '89991234560');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (2, 2, 'Имя2', 'Фамилия2', 'Отчество2', '89995674560');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (3, 3, 'Имя3', 'Фамилия3', 'Отчество3', '89991454560');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (4, 3, 'Имя4', 'Фамилия4', 'Отчество4', '89993434560');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (5, 5, 'Имя5', 'Фамилия5', 'Отчество5', '89990004560');
